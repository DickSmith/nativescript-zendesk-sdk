...
Current typings/metadata were generated using version `ios@1.10.1.1` and ``android@1.10.0.1` of the Zendesk and Zendesk Provider SDKs.
...
cd lib
jar xf sdk-1.10.0.1.aar
mv classes.jar used-zendesk-sdk.jar
jar xf sdk-providers-1.10.0.1.aar
