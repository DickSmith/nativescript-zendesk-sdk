...
declare class ZDKUserProvider extends NSObject {
	...
	addTagsCompletion(tags: NSArray<string>, completion: (p1: NSArray<string>, p2: NSError) => void): void;

	deleteTagsCompletion(tags: NSArray<string>, completion: (p1: NSArray<string>, p2: NSError) => void): void;
