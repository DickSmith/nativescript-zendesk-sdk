...
declare class ZDKHelpCenterUi extends NSObject {
	...
	static buildHelpCenterArticleAndConfigs(article: ZDKHelpCenterArticle, configs: NSArray<ZDKUiConfiguration>): UIViewController;

	static buildHelpCenterArticleWithArticleId(articleId: string): UIViewController;

	static buildHelpCenterArticleWithArticleIdAndConfigs(articleId: string, configs: NSArray<ZDKUiConfiguration>): UIViewController;

	static buildHelpCenterOverview(): UIViewController;

	static buildHelpCenterOverviewWithConfigs(configs: NSArray<ZDKUiConfiguration>): UIViewController;
...
declare class ZDKRequestUi extends NSObject {
	...
	static buildRequestListWith(configurations: NSArray<ZDKUiConfiguration>): UIViewController;

	static buildRequestUi(): UIViewController;

	static buildRequestUiWith(configurations: NSArray<ZDKUiConfiguration>): UIViewController;

	static buildRequestUiWithRequestId(requestId: string): UIViewController;

	static buildRequestUiWithRequestIdConfigurations(requestId: string, configurations: NSArray<ZDKUiConfiguration>): UIViewController;
...
declare class ZDKToastViewWrapper extends UIView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): ZDKToastViewWrapper; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ZDKToastViewWrapper; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): ZDKToastViewWrapper; // inherited from UIAppearance
...
interface ZDKUiConfiguration extends NSObjectProtocol {

	init?(): ZDKUiConfiguration;
}
declare var ZDKUiConfiguration: {

	prototype: ZDKUiConfiguration;
};

declare class ZendeskFabric extends NSObject {

	static alloc(): ZendeskFabric; // inherited from NSObject

	static new(): ZendeskFabric; // inherited from NSObject
}

declare class ZendeskWrapperUIX extends NSObject {

	static alloc(): ZendeskWrapperUIX; // inherited from NSObject

	static new(): ZendeskWrapperUIX; // inherited from NSObject

	static setupActionHandlers(): void;
}
